...
# View Mode 2: Content Library — Post Performance
...
# ============================================================
# Section 3: COMMUNITY HEALTH — ENGAGEMENT FUNNEL & LEADERBOARD
# ============================================================
...
def show_organic_architecture():
    ...
    df = data_loader.load_organic_data()
    ...
    # --- Section 1: Cross-Channel Pulse (all platforms, unfiltered) ---
    ...
    # --- Section 2: Content Library (detailed posts data) ---
    content_library_section(platform_filter)

    st.markdown('<div class="section-divider"></div>', unsafe_allow_html=True)

    # --- Section 3: Metric Stacks (key metrics breakdown) ---
    render_metrics_stacks(df)

    st.markdown('<div class="section-divider"></div>', unsafe_allow_html=True)

    # --- Section 4: Engagement Funnel & Leaderboard ---
