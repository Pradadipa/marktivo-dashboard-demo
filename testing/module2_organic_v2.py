...
def inject_custom_css():
    ...
    <style>
        ...
        /* Content Card */
        .content-card {
            background: linear-gradient(135deg, #1B1F2B 0%, #222838 100%);
            border: 1px solid #2D3348;
            border-radius: 12px;
            overflow: hidden;
            transition: all 0.3s ease;
        ...
        .score-badge-virality {
            background: rgba(168, 85, 247, 0.15);
            color: #A855F7;
        }

        .score-badge-conversion {
...
def show_organic_architecture():
    ...
    # --- Section 5: Content Library Grid ---
    ...
    <div style="text-align: center; padding: 40px; color: #5A6577;">
        ...
        <div style="font-size: 13px; text-transform: uppercase; letter-spacing: 2px;">
            More sections coming: Engagement Funnel · Content Leaderboard · AI Brain
        </div>
    </div>
    """, unsafe_allow_html=True)
